...
| Component | Status |
|---|---|
| Contracts | Written, tested (`79` unit tests + `18` fuzz targets + `9` invariants), NOT audited |
...
| DRW distribution | `DRWFaucet`, `./ops/init_drw_faucet.sh`, and the portal claim path now provide a transparent third-party onboarding route; the live Base Sepolia faucet is `0x3DAa29B6b497a830AA5C3e4eE881ad2fFe2FbAe0`, funded with `100,000 DRW` + `0.0002 ETH` |
