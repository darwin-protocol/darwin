...
| Market bootstrap | `ops/preflight_market_bootstrap.py` checks whether a wallet can honestly seed a small `DRW/WETH` market; this is a readiness aid, not a market-manipulation tool |
